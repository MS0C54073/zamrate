...
1. Sign up at `/admin-login` with the designated admin email.
2. A super-admin grants your role from **Admin → Sub-Admins**.
3. The bootstrap super-admin is **zamrate@proton.me** (seeded via migration).
